...
## Project Structure
    ...
    ├── testapiautosetting_127228  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127228`
...
2. Clone this repo and `cd testapiautosetting_127228`
